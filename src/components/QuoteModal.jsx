    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-2 sm:p-4 md:p-6 overflow-y-auto">
        ...
        <motion.div
          ...
          className="relative w-full max-w-2xl bg-white shadow-2xl z-10 border border-black/10 max-h-[94vh] sm:max-h-[90vh] overflow-y-auto my-auto rounded-xs"
          onClick={(e) => e.stopPropagation()}
        >
          {/* Header Banner */}
          <div className="sticky top-0 z-20 bg-black text-white px-4 sm:px-6 py-3.5 sm:py-4 flex items-center justify-between border-b border-white/10">
            <div className="flex items-center gap-2.5 sm:gap-3">
              ...
              <div className="border-l border-white/20 pl-2.5 sm:pl-3">
                <h3 className="font-serif text-base sm:text-lg font-bold tracking-tight text-white leading-tight">
                  Request a Project Quote
                </h3>
                <p className="text-[10px] sm:text-[11px] text-white/60 tracking-wider uppercase">
            ...
            <button
              onClick={onClose}
              className="w-8 h-8 sm:w-9 sm:h-9 bg-white/10 hover:bg-[#FF7A00] text-white flex items-center justify-center transition-colors"
            ...
            {!isSubmitted ? (
              <form className="space-y-4 sm:space-y-6">
                ...
                <div className="space-y-3 sm:space-y-4">
                  <div className="text-[11px] sm:text-xs font-bold uppercase tracking-widest text-[#FF7A00] pb-1 border-b border-black/10">
                    1. Contact Information
                  </div>

                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                    <div>
                      <label className="block text-[11px] sm:text-xs font-semibold text-black/80 uppercase tracking-wider mb-1">
                      ...
                      <input
                        ...
                        className="w-full px-3.5 py-2.5 bg-neutral-50 border border-black/15 focus:border-[#FF7A00] focus:bg-white text-black text-base sm:text-sm outline-none transition rounded-xs"
                      />
                    </div>
                ...
                <div className="space-y-3 sm:space-y-4 pt-1 sm:pt-2">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                    ...
                    <div>
                      ...
                      <select
                        ...
                        className="w-full px-3.5 py-2.5 bg-neutral-50 border border-black/15 focus:border-[#FF7A00] focus:bg-white text-black text-base sm:text-sm outline-none transition rounded-xs"
                      >
                        <option value="Residential (Villa/House)">Residential (Villa / House)</option>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full px-3.5 py-2.5 bg-neutral-50 border border-black/15 focus:border-[#FF7A00] focus:bg-white text-black text-base sm:text-sm outline-none transition resize-none rounded-xs"
                    />
                  </div>
                </div>

                {/* Submit Buttons */}
                <div className="pt-3 border-t border-black/10 flex flex-col sm:flex-row items-center gap-2.5 sm:gap-3">
                  <button
                    type="button"
                    onClick={handleWhatsAppSubmit}
                    className="w-full sm:flex-1 py-3.5 px-5 bg-[#FF7A00] text-white hover:bg-[#FF7A00]/90 transition-all font-medium text-sm flex items-center justify-center gap-2 shadow-md"
                  >
                  ...
                  <button
                    ...
                    className="w-full sm:flex-1 py-3.5 px-5 bg-black text-white hover:bg-neutral-800 transition-all font-medium text-sm flex items-center justify-center gap-2"
                  >
                ...
                <p className="text-center text-[10px] sm:text-[11px] text-black/50">
              ...
              <div className="py-6 sm:py-8 text-center space-y-4 sm:space-y-5">
                ...
                <h4 className="font-serif text-xl sm:text-2xl md:text-3xl text-black font-bold">
                  Quote Request Initiated!
                </h4>
                <p className="text-black/70 text-xs sm:text-sm max-w-md mx-auto">
                ...
                <div className="p-3.5 sm:p-4 bg-neutral-50 border border-black/10 max-w-md mx-auto text-xs text-left space-y-1.5">
                ...
                <div className="pt-2 sm:pt-4 flex justify-center gap-4">
                  <button
                    onClick={resetForm}
